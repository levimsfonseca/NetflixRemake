...
import co.levifonseca.netflixremake.util.DownloadImageTask
import co.levifonseca.netflixremake.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=dd3fa851-abcd-45a7-8649-0ed58214b565"
